    ...
    return new Promise(resolve => {
        ...
        vscode.window.showInputBox({
            ...
            if (value) {
                ...
                const end = cacheMap.get(currentFileName.value as string)?.scriptTagLine.end;
                ...
                vscode.window.activeTextEditor?.edit(editBuilder => {
                    ...
                    // 更新缓存
                    const currentCache = cacheMap.get(currentFileName.value as string);
                    if (cacheMap.get(currentFileName.value as string)) {
                        cacheMap.set(currentFileName.value as string, {
                            ...currentCache,
                            scriptTagLine: {
